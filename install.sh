...
# Script from https://gitlab.com/librephoenix/nixos-config/-/blob/main/install.sh?ref_type=heads
...
nix-shell -p git --command "git clone https://gitlab.com/redlonghead/nixos-config $SCRIPT_DIR"
